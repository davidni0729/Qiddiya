...
export const metadata: Metadata = { title: "隱私權聲明" };

export default function PrivacyPage() {
  return (
    <LegalLayout eyebrow="PRIVACY SIGNAL" title="隱私權聲明" updated="2026 年 8 月 27 日">
      <section><h2>一、資料蒐集目的</h2><p>Qiddiya 奇地亞由 TianYen 發起。本網站蒐集預先登記資料，用於活動通知、名單管理、參與偏好分析，以及在取得額外同意時提供後續品牌活動資訊。</p></section>
      <section><h2>二、蒐集的資料</h2><p>必要資料包括姓名、Email、得知活動的方式與隱私權同意紀錄；手機、所在城市、Instagram、體驗偏好與行銷通知同意為選填資料。</p></section>
